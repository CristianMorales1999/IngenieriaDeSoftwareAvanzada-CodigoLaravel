...
class StoreUserRequest extends FormRequest
{
     ...
     * En este caso, permitimos que cualquier usuario autenticado pueda crear usuarios.
     * En un entorno real, podrías querer restringir esto a administradores.
     *
     * @return bool
     */
    public function authorize(): bool
    {
        return true; // Permitir a todos los usuarios crear usuarios
    }
