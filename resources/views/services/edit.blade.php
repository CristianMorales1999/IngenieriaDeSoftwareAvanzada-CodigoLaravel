...
@section('description', 'Edita tu servicio en ServiPro')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="category" name="category" 
                        ...
                        <option value="Marketing Digital" {{ old('category', $service->category) == 'Marketing Digital' ? 'selected' : '' }}>Marketing Digital</option>
                        <option value="Consultoría" {{ old('category', $service->category) == 'Consultoría' ? 'selected' : '' }}>Consultoría</option>
                        <option value="Educación" {{ old('category', $service->category) == 'Educación' ? 'selected' : '' }}>Educación</option>
                        <option value="Otros" {{ old('category', $service->category) == 'Otros' ? 'selected' : '' }}>Otros</option>
                    </select>
                    @error('category')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="price" name="price" value="{{ old('price', $service->price) }}" min="0" step="0.01"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="4" 
                              ...
                              placeholder="Describe detalladamente tu servicio, incluyendo lo que incluye, tiempo de entrega, etc." required>{{ old('description', $service->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                @if($service->image_path)
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <p class="text-sm text-gray-600">Imagen actual del servicio</p>
                ...
                <!-- Nueva imagen del servicio -->
                <div class="md:col-span-2">
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ $service->image_path ? 'Nueva Imagen del Servicio' : 'Imagen del Servicio' }}
                    </label>
